        ...
        <div className="relative w-full" ref={wrapperRef}>
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border border-blue-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#005ee6] focus:border-transparent dark:bg-gray-800 dark:text-white shadow-sm transition-all text-sm"
                    value={query}
                    onChange={(e) => {
            ...
            {isOpen && query.length > 0 && (
                <div className="absolute top-full left-0 mt-2 w-full bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-xl max-h-96 overflow-y-auto z-50">
