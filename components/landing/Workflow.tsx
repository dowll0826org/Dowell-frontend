        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-4 relative z-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t("workflow.steps.upload.title")}</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t("workflow.steps.process.title")}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 px-2 leading-relaxed">
                {t("workflow.steps.process.description")}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t("workflow.steps.download.title")}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 px-2 leading-relaxed">
                {t("workflow.steps.download.description")}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t("workflow.steps.autoDelete.title")}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 px-2 leading-relaxed">
                {t("workflow.steps.autoDelete.description")}
              </p>
            </div>
