            ...
            <div className="container mx-auto px-4 sm:px-8 lg:px-16 max-w-7xl">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="max-w-xl">
                        ...
                        {/* Heading */}
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[4.5rem] font-extrabold text-gray-900 dark:text-white leading-[1.05] mb-8 tracking-tight break-words sm:break-normal">
                            {t("hero.headline1")}<br />
                            <span className="text-[#005ee6] dark:text-blue-500 break-all sm:break-normal">{t("hero.headline2")}</span>
                        </h1>
