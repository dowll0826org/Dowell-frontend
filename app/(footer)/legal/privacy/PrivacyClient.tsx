...
import { usePrivacyPolicyData } from '@/lib/data';
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24 w-full">
        <div className="mb-10 text-center">
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl mx-auto text-lg">
            {t("legal.privacy.intro", "This Privacy Policy describes how we collect, use, and handle your information.")}
          </p>
        </div>
                  ...
                  {section.contactBox && (
                    <div className="bg-[#f8fafc] dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-xl p-6 mt-6">
                      <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                        <p><strong className="text-gray-900 dark:text-white">{t("common.email")}:</strong> {section.contactBox.email}</p>
                      </div>
                    </div>
                  )}
                </div>
