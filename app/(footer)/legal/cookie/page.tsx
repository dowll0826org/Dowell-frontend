        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm">
                  <thead className="bg-[#f8fafc] dark:bg-gray-700/50 text-gray-500 dark:text-gray-400">
                    <tr>
                      <th className="px-8 py-4 font-medium text-xs uppercase tracking-wider">Cookie Name</th>
                      <th className="px-8 py-4 font-medium text-xs uppercase tracking-wider">Type</th>
                      <th className="px-8 py-4 font-medium text-xs uppercase tracking-wider">Duration</th>
                      <th className="px-8 py-4 font-medium text-xs uppercase tracking-wider">Purpose</th>
                    </tr>
                  </thead>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#f4f7fb] dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3">Manage Preferences</h3>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-sm font-semibold text-gray-900 dark:text-white">Essential Cookies</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Always active</div>
                  </div>
                  <div className="relative inline-flex h-5 w-9 flex-shrink-0 cursor-not-allowed rounded-full border-2 border-transparent bg-[#1c4794] opacity-50 dark:bg-blue-600 transition-colors duration-200 ease-in-out focus:outline-none">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-[#1c4794] dark:bg-blue-600 transition-colors duration-200 ease-in-out focus:outline-none">
                    <span className="translate-x-4 pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"></span>
                  </div>
                </div>
              </div>
