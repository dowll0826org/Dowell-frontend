...
function DashboardNavbar() {
  return (
    <header className="h-16 flex-shrink-0 border-b border-gray-200 dark:border-gray-800 bg-[#fbfcfd] dark:bg-gray-950 flex items-center sticky top-0 z-20">
      ...
      <div className="flex-1 px-6 flex items-center justify-center bg-white dark:bg-gray-950 h-full">
